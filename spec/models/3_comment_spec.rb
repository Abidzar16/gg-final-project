...
RSpec.describe Comment do
  ...
  describe '#save' do
    ...
    let(:tested_object) { described_class.new({:id => id, :content => content, :user_id => user_id, :post_id => post_id}) }
    ...
    let(:expected_result) do
      described_class.new({:id => recorded_user['id'], :content => recorded_user['content'], :user_id => recorded_user['user_id'], :post_id => recorded_user['post_id']})
    end
